  ...
  sendEmailStudentAdmission: async function (data, student_number) {
    return new Promise(async (resolve, reject) => {
      ...
      const html = `
				...
				<head>
					<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
					<title>Student Admission Announcement</title>
					<meta name="description" content="Student Admission Announcement.">
					<style type="text/css">
						a:hover {text-decoration: underline !important;}
					</style>
				</head>
									...
									<tr>
										<td>
											<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td style="padding:0 35px;">
														<h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Dear ${
                              data.name
                            }</h1>
														<span
															style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                ...
                                data.departement_data
                                  ? data.departement_data.faculty.name
                                  : ""
